...
export default function AboutPage() {
  return (
    <>
      ...
      <main
        className="min-h-screen bg-[#F7FAFF] py-12 px-4 sm:px-6 lg:mx-36"
        role="main"
    ...
    >
      <Accordion.Item className="AccordionItem" value="item-1">
        ...
        <Accordion.Content className="text-base font-normal mt-4">
          ...
          <a href="https://opencodechicago.org" target="_blank">
      ...
      <Accordion.Item className="AccordionItem" value="item-2">
        ...
        <Accordion.Content className="text-base font-normal mt-4">
          <p>
            Explore our collections like Pre-Workout, Build Muscle, and more.
          </p>
          <p className="mt-2">
            Use filters to find products by category or benefit.
          </p>
        </Accordion.Content>
      </Accordion.Item>
      ...
      <Accordion.Item className="AccordionItem" value="item-3">
        ...
        <Accordion.Content className="text-base font-normal mt-4">
          ...
          <p className="mt-2">
            Your selected items will appear in the cart, ready for checkout.
          </p>
        </Accordion.Content>
      </Accordion.Item>
      ...
      <Accordion.Item className="AccordionItem" value="item-4">
        ...
        <Accordion.Content className="text-base font-normal mt-4">
          ...
          <p className="mt-2">
            Please note: This is a demo-only product. No payments are processed
            — this is part of our open source learning initiative with Open Code
            Chicago.
          </p>
        </Accordion.Content>
      </Accordion.Item>
      ...
      <Accordion.Item className="AccordionItem" value="item-5">
        ...
        <Accordion.Content className="text-base font-normal mt-4">
          ...
          <ul className="list-disc list-inside">
            ...
            <li className="ml-2">
              Check open issues (features, bugs, or docs).
            </li>
            <li className="ml-2">
              Pick a task, follow contribution guidelines, and submit a PR.
            </li>
          </ul>
        </Accordion.Content>
      </Accordion.Item>
